...
import { ArrowLeft, Mail, Lock, Terminal, Globe, Loader2, AlertCircle } from "lucide-react";
...
export default function SignInPage() {
  ...
  return (
    <GridBackground variant="dots" className="flex min-h-screen w-full flex-col font-sans selection:bg-rose-500/30">
      ...
      <div className="absolute bottom-[10%] left-[20%] w-[500px] h-[300px] bg-orange-500/10 dark:bg-orange-500/15 blur-[120px] rounded-full pointer-events-none mix-blend-multiply dark:mix-blend-screen" />
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="relative p-[1px] rounded-[2.5rem] bg-gradient-to-b from-black/5 via-black/5 to-transparent dark:from-white/20 dark:via-white/5 dark:to-transparent shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] group overflow-visible">
            ...
            <div className="absolute -inset-2 bg-gradient-to-r from-orange-500 via-rose-500 to-indigo-500 opacity-0 group-hover:opacity-10 dark:group-hover:opacity-20 blur-2xl transition-opacity duration-1000 pointer-events-none rounded-[3rem]" />
              ...
              <div className="relative z-10">
                <div className="text-center mb-10">
                  <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-zinc-100/50 dark:bg-white/5 border border-zinc-200/50 dark:border-white/10 mb-6 shadow-inner relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-tr from-rose-500/10 to-indigo-500/10 dark:from-rose-500/20 dark:to-indigo-500/20 opacity-50" />
                    <Lock className="w-6 h-6 text-zinc-700 dark:text-white relative z-10" />
                  </div>
                  <h1 className="text-3xl font-extrabold tracking-tighter text-zinc-900 dark:text-white mb-2 drop-shadow-sm">Welcome back</h1>
                  <p className="text-sm text-zinc-500 dark:text-white/50 font-medium">Sign in to orchestrate your Firebase security</p>
                </div>
                ...
                <div className="relative mb-8">
                  ...
                  <div className="relative flex justify-center text-xs uppercase tracking-widest font-bold">
                    <span className="bg-white/90 dark:bg-zinc-950 px-4 text-zinc-400 dark:text-white/30 backdrop-blur-md rounded-full py-0.5">Or continue with</span>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex items-center justify-between text-xs pt-1 px-1">
                    <label className="flex items-center gap-2 text-zinc-500 dark:text-white/40 cursor-pointer hover:text-zinc-900 dark:hover:text-white/80 transition-colors font-medium">
                      <input type="checkbox" className="rounded border-zinc-300 dark:border-white/10 bg-white dark:bg-black/50 text-rose-500 focus:ring-rose-500/30 focus:ring-offset-0" />
                      Remember me
                    </label>
                    <Link 
                      href="/forgot-password"
                      className="text-zinc-500 dark:text-white/40 hover:text-zinc-900 dark:hover:text-white/80 font-medium transition-colors"
                    >
                      Forgot password?
                    </Link>
                  </div>
                  ...
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="w-full h-12 mt-6 rounded-2xl bg-gradient-to-r from-orange-500 via-rose-500 to-indigo-500 text-white font-bold tracking-wide shadow-[0_10px_20px_-10px_rgba(244,63,94,0.5)] dark:shadow-[0_0_20px_rgba(244,63,94,0.3)] hover:shadow-[0_15px_25px_-10px_rgba(244,63,94,0.6)] dark:hover:shadow-[0_0_40px_rgba(244,63,94,0.5)] hover:scale-[1.02] transition-all duration-300 group overflow-hidden relative flex items-center justify-center border border-white/20 disabled:opacity-50 disabled:hover:scale-100"
                  >
                ...
                <div className="mt-8 text-center text-sm text-zinc-500 dark:text-white/40 font-medium">
                  ...
                  <Link href="/sign-up" className="text-zinc-900 dark:text-white hover:text-rose-500 dark:hover:text-rose-400 font-bold hover:underline decoration-zinc-300 dark:decoration-white/30 underline-offset-4 transition-colors">
                    Sign up
                  </Link>
                </div>
              </div>
